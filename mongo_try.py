...
def post_raw_data():
    ...
    while cycle_id < cycle + 1:
        ...
        ''' Encapsulate the RAW DATA into bucket '''
        ...
        while avgPos < column + 1:
            ...
            # bucket['raw_data'].append({'run': avgPos, 'result': value})
            field_name = 'raw_data_' + str(avgPos)
...
if __name__ == '__main__':
    ...
    # echoes_db.createIndex( [( 'battery_id', pymongo.ASCENDING )],
    #                         unique=False, collection=cabinet)
    echoes_db.createIndex( [( 'capture_number', pymongo.ASCENDING )],
                            unique=False, collection=cabinet)
    # echoes_db.createIndex( [( 'SoH', pymongo.ASCENDING )],
    #                         unique=False, collection=cabinet)
